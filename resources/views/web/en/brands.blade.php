    ...
    <div class="container">
        <div class="row">
            <div class="col-12 mb-4">
                <h2 class=" wow animate__animated  animate__fadeInDown">Our brands</h2>
            </div>
                ...
                <div class="brands-boxing w-100">
                    <div class="row">
                        ...
                        <div class="col-12 d-flex justify-content-end">
                            <a href="{{ route('listProducts', ['lang'=>"en" , 'brand'=>$key->url_seo]) }}" class="btn ms-2 btn-primary">Look more products</a>
                        </div>
                    </div>
                </div>
            </div>
