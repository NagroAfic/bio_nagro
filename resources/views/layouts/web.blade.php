    ...
    <footer class="footer">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <p class="text-white mb-1">Redes Sociales</p>
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <a href="tel:+51945143317" class="text-white text-decoration-none ms-3">945143317</a>
                    </div>
                    <div class="d-flex align-items-center mb-3">
                ...
                <div class="col-md-4">
                    <p class="text-white mb-1">Contacto</p>
                    <div class="d-flex align-items-center mb-3">
                ...
                <div class="col-12 d-flex justify-content-center align-items-center">
                    <span class="text-white fw-light"><i>Bioserviceclab</i></span>
                </div>
            </div>
        </div>
    </footer>
